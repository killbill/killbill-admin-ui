...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/RubyMoney/monetize/issues", "changelog_uri" => "https://github.com/RubyMoney/monetize/blob/master/CHANGELOG.md", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/RubyMoney/monetize/" } if s.respond_to? :metadata=
